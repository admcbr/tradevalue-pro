...
const PLANS = [
  {
    ...
    desc: { uk: '3 дні безкоштовно — повний доступ', ru: '3 дня бесплатно — полный доступ' },
    features: {
      uk: [
        'Повний функціонал на 3 дні',
        'Необмежена кількість оцінок',
        'Всі категорії та правила',
        'Команда менеджерів',
        'Статистика та AI ліквідність',
        'Трейд-Ін та Експорт CSV',
      ],
      ru: [
        'Полный функционал на 3 дня',
        'Неограниченное количество оценок',
        'Все категории и правила',
        'Команда менеджеров',
        'Статистика и AI ликвидность',
        'Трейд-Ин и Экспорт CSV',
      ],
    },
    blocked: { uk: [], ru: [] },
  },
